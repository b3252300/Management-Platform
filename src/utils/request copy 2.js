...
// const { Lifflogin, getLiffIDToken  } = lifffunction();

// console.log(getLiffIDToken, "getLiffIDToken");
  ...
  setInterceptors(instance) {
    ...
    instance.interceptors.request.use(
      (config) => {
        ...
        if (currentMobile && config.headers['x-No-LiffToken'] === undefined) {
        ...
        if (config.headers['x-No-Encryption'] === "true") {
          ...
          return config;
            ...
            if(currentMobile && list.Data["LineIdToken"] == undefined || !list.Data["LineIdToken"]){
