<template>
        ...
        <div class="container-date-btn"> 
            <template v-for="date in nextWeekDates" :key="date.dateType">
                ...
                <el-button type="primary" @click="column(date.dateTop, date.dataToday)" plain v-if="date.weekType !== '日'" :class="[date.dateType === timeWithWeekday ? 'style_active' : '', 'text-black']">
